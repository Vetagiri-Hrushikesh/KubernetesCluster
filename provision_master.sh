...
# Generate the join command and save it to /vagrant/join_master.sh
kubeadm token create --print-join-command > /vagrant/join_master.sh
echo "Master is ready, and the join command is saved to /vagrant/join_master.sh"
